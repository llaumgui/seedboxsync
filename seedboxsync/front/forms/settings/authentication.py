...
class SettingsAuthenticationForm(FlaskForm):  # type: ignore[misc]
    ...
    # OAuth2 / OIDC
    oauth_enabled = BooleanField(_("Enable OAuth2 / OIDC for the authentication?"))
    oauth_auto_create_user_enabled = BooleanField(_("Auto-create users?"))
    oauth_builtin_authentication_disabled = BooleanField(_("Disable built-in authentication?"))
    ...
    oauth_server_metadata_url = URLField(_("OIDC Server Metadata URL"), render_kw={"placeholder": "05e20c6e-2c69-4501-919f-4f44be05ac0b", "icon": "fa-link"})
