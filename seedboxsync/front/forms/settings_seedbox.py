...
class SettingsSeedboxForm(FlaskForm):  # type: ignore[misc]
    """
    Form for configuring remote Seedbox connection and synchronization parameters.

    Manages host authentication, protocol parameters, path definitions, and
    file filtration rules for the seedbox integration.
    """
