...
from seedboxsync.core.database.models import SeedboxSync, typed_peewee_dicts
...
class Config:
    ...
    DEFAULT_CONFIG: ClassVar[dict[str, Any]] = {
        ...
        CONFIG_NAMESPACE + "OAUTH_AUTO_CREATE_USER_ENABLED": False,
        CONFIG_NAMESPACE + "OAUTH_BUILTIN_AUTHENTICATION_DISABLED": False,
    ...
    def _convert_config_value(config_key: str, value: Any) -> Any:
        ...
        if normalized_key.endswith(("_ENABLED", "_DISABLED")):
